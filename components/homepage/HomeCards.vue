<template>
	<div class="page-home-cards">
		<div
			class="page-home-card basic"
			:class="{ show: homeCardStore.basicCard }"
		>
			<div class="page-home-card__title">可以点一下关注吗</div>
			<HomeBasic />
		</div>
		<div
			class="page-home-card ability"
			:class="{ show: homeCardStore.abilityCard }"
		>
			<div class="page-home-card__title">等我26年考出去</div>
			<HomeAbility />
		</div>
		<div
			class="page-home-card interest"
			:class="{ show: homeCardStore.interestCard }"
		>
