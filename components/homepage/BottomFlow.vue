<template>
	<div class="aurle-home-flow">
		<div
			class="aurle-flow-card basic"
			:class="{ active: homeCardStore.basicCard }"
			@click="homeCardStore.handleCard('basic')"
		>
		...
		<div
			class="aurle-flow-card ability"
			:class="{ active: homeCardStore.abilityCard }"
			@click="homeCardStore.handleCard('ability')"
		>
			<div class="aurle-flow-card__background">
				<div class="image">
		...
		<div
			class="aurle-flow-card interest"
			:class="{ active: homeCardStore.interestCard }"
			@click="homeCardStore.handleCard('interest')"
		>
			<div class="aurle-flow-card__background">
				<div class="canvas">
