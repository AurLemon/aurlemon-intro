...
const languageColors: any = languageColorsMap
...
const fetchRepositories = async () => {
    try {
        const response = await fetch(`https://api.github.com/users/${GITHUB_USER_NAME}/repos`)
...
<template>
    <div class="aurle-github-repo">
        <div class="aurle-github-repo-list">
            <div class="aurle-github-repo-item" v-for="repo in repositories" :key="repo.id" v-tooltip="{ content: repo.description }">
                <a :href="repo.html_url" target="_blank">
                    <div class="aurle-github-repo-item__title">
                        <span class="aurle-github-repo-item__color" :style="{ backgroundColor: getLanguageColor(repo.language) }"></span>
                        {{ repo.name }}
                    </div>
                    <div class="aurle-github-repo-item__wrapper">
                        <!-- <div class="aurle-github-repo-item__desc">{{ repo.description }}</div> -->
                        <div class="aurle-github-repo-item__info">
                            <div class="aurle-github-repo-item__data aurle-github-repo-item__language" v-if="repo.language">
                                {{ repo.language }}
                            </div>
                            <div class="aurle-github-repo-item__data aurle-github-repo-item__star" v-if="repo.stargazers_count">
                                {{ repo.stargazers_count }}
                            </div>
                            <div class="aurle-github-repo-item__data aurle-github-repo-item__fork" v-if="repo.forks_count">
                                {{ repo.forks_count }}
                            </div>
                        </div>
                    </div>
