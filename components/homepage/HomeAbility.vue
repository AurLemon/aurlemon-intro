	...
	<div class="aurle-home-ability">
		<div class="aurle-home-item school">
			<div class="aurle-home-item__background">
				<img
					v-if="currentStage === 0"
					src="~/assets/images/badge/FPM_Logo.png"
				/>
				<img
					v-if="currentStage === 1"
					src="~/assets/images/badge/FEES_Logo.png"
				/>
				<img
					v-if="currentStage === 2"
					src="~/assets/images/badge/FJCCC_Logo.png"
				/>
				<div
					class="text"
					:style="{ color: `${collegeList[currentStage].color}66` }"
				>
					{{ collegeList[currentStage].end_time }}
				</div>
			</div>
			<div
				class="aurle-home-item__foreground"
				:style="{
					background: `linear-gradient(-45deg, ${collegeList[currentStage].color} -100%, transparent), radial-gradient(circle at top left, transparent 0% 8%, ${collegeList[currentStage].color}1a 8% 12%, transparent 12% 100%)`,
				}"
			>
				<div class="aurle-home-item__title">
					{{ collegeList[currentStage].comment }}
				</div>
				<div class="aurle-home-item__desc">
					<div class="aurle-home-item__badge">
						<img
							@click="changeCurrentCollegeStage(2)"
							@mouseenter="changeCurrentCollegeStage(2)"
							:class="{ active: currentStage === 2 }"
							src="~/assets/images/badge/FJCCC_Logo.png"
						/>
						<img
							@click="changeCurrentCollegeStage(1)"
							@mouseenter="changeCurrentCollegeStage(1)"
							:class="{ active: currentStage === 1 }"
							src="~/assets/images/badge/FEES_Logo.png"
						/>
						<img
							@click="changeCurrentCollegeStage(0)"
							@mouseenter="changeCurrentCollegeStage(0)"
							:class="{ active: currentStage === 0 }"
							src="~/assets/images/badge/FPM_Logo.png"
						/>
					</div>
					<div class="aurle-home-item__type">
						{{ collegeList[currentStage].stage }}
					</div>
				</div>
				<div class="aurle-home-item__subtitle">
					<div class="aurle-home-item__time">
						{{ collegeList[currentStage].start_time }} ~
						{{ collegeList[currentStage].end_time }}
					</div>
				...
				<div class="aurle-home-item__foreground">
					...
					<div class="aurle-home-item__button">
						<div class="aurle-home-item__link main">
							<a
								href="https://fjcpc-teps.aurlemon.top/"
								target="_blank"
						...
						<div class="aurle-home-item__link bilibili">
							<a
								href="https://www.bilibili.com/video/BV1Fjm6Y3EJ2"
								target="_blank"
								rel="noopener noreferrer"
							>
	...
	.aurle-home-item {
		...
		&.s-card {
			...
			.aurle-home-item__foreground {
				...
				background:
					linear-gradient(-45deg, rgba(185, 230, 253, 0.25), transparent 70%),
					radial-gradient(
						circle at bottom left,
						transparent 0% 10%,
						rgba(184, 213, 225, 0.1) 10% 20%,
						transparent 20% 100%
					);
		...
		&.location {
			...
			.aurle-home-item__foreground {
				background:
					linear-gradient(-45deg, rgba(190, 225, 187, 0.25), transparent 70%),
					radial-gradient(
						circle at bottom left,
						transparent 0% 10%,
						rgba(196, 225, 184, 0.1) 10% 20%,
						transparent 20% 100%
					);
			}
		}
		...
		&.education {
			.aurle-home-item__foreground {
				background:
					linear-gradient(-45deg, rgba(156, 183, 221, 0.25), transparent 70%),
					radial-gradient(
						circle at bottom left,
						transparent 0% 10%,
						rgba(184, 196, 225, 0.1) 10% 20%,
						transparent 20% 100%
					);
			}
		}
