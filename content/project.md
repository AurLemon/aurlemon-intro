...
* 2024.6 - 现在 → Hydroline Leader<br>
从氢气工艺（上面的 MC 服务器）衍生出来的，写代码的小工作室，啥都写。看似 GitHub 组织里有好几个人实际上在干活的就我一个。

* 2024.12 - 现在 → [LawerLab](https://lawerlab.cn) 第二开发<br>
一个律师朋友给自己搞小工具的工作室（可能算不上工作室，就两个人），在里面弄小程序前端（Uniapp）和一点后端，我主要搞他分给我的工和改屎山

* 2025.7 - 现在 → Volya 网站开发<br>
一个老哥从我的 Wiki.js CSS 一路看到了这个网站，然后！给我发了个 EMail 问我愿不愿意加入他的项目，这里不多说了，和书有关（但是我好像有点鸽）。

* 2025.9 → 世界职业院校技能大赛总决赛争夺赛（新一代信息技术赛道）铜奖<br>
在里面打杂的，感恩老师感恩学校感恩队友，给我混上了。我用 Rust 写了个无人机后端嘿嘿（Vibe Coding）。

至于说其他方面的就粗略列几个：

* 名下三个域名，三个备案了 + 腾讯云忠实用户。
