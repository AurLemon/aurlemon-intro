...
5. [自分の Minecraft サーバーの Portal サイト](https://github.com/AurLemon/hydcraft-portal)（2026）。Nuxt ベースの Web プロジェクトだ。実はその前に失敗した前身プロジェクトが一つある。もう少し時間が経って完成したら、ここに詳しい内容を追記したい。今は仮置きということで。
