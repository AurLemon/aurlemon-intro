...
严正声明：本站所有内容（文档、代码、动效）都是我 1:1 调出来的，说我是用 AI 做的是对我的**侮辱**。我可是连即时设计原文件都在的。当然！我的小作文或许写的有点人机味，但这不代表我全是 AI 跑的。不要侮辱我。

但是肯定有 Agent 协助完成的功能。**有！** 但我是 Instructor。页眉 Header 那个 Blur + Mask 的效果可是我浏览器里面测好了手搓 TailwindCSS 放进去的，请不要侮辱我，特别是我的 UI 和 CSS 能力。本站的字体都是我去 Google Fonts 一个个挑的，更何况每个功能。
