...
The list above shows the anime and books I have gone through. To be honest, I have watched very little anime in recent years, let alone read physical books. Over the last year, most of the physical books I bought were just exam-prep materials for CET-4 and CET-6. If you asked what I usually watch, I would probably say yuri, light yuri, slice-of-life, and that is about it. I used to watch some BG too. It is not that I never watch it anymore, just much less than before.

As for why I suddenly started watching anime again, and even got into GL around late 2025, that was actually kind of accidental. I have a habit of leaving a small video window playing in the upper-right corner while I code, basically as background noise. Otherwise waiting for the Agent to reply feels too slow. I am not really watching it closely anyway, mostly just listening. If I tried to look back and forth between both sides all the time, it would be too exhausting.
...
In UI design, I like whitespace and card-grid layouts. Recently I have especially liked using serif type, like on this site right now. Sometimes I also throw in a few emoji as visual anchors to add a bit more impact 😡👊. I really appreciate this kind of design direction: white, gray, and black as the base, with an accent color plus Blur / Shadow transitions. I do not even know what style name to give it. Maybe it leans pretty heavily toward Apple? I genuinely do like iOS design, especially its motion work. That Apple ID face-payment animation is ridiculously cool.

The websites of companies like Claude and OpenAI fit that pattern very well. Clean design feels very geeky. Restraint matters most. The detail from Claude that surprised me the most is a very "subtractive" choice: when you hover over a link, it does not deliberately highlight the current item. Instead, it dims the neighboring peer elements. It uses lower visual weight on other information to bring focus to the target. That is restraint pushed very far.

By contrast, Google's Material Design is not something I can really appreciate. The overuse of Morandi colors feels messy and over-decorated. I actually liked the first generation of Material Design quite a bit. I do not know how it ended up becoming this.

## Other

Beyond that, I honestly cannot think of many preferences worth putting into words. Programming probably does not count as a hobby for me anymore, especially when the code is not even written by me, but by the Agent. The Agent does the work; I pressure it. If I had to name other topics that might still be somewhat interesting, maybe drinking Monster and sleeping? My phone is Xiaomi, my computer is Mechanical Revolution. You could call them the kings of cost-performance. Lately I have also been wondering whether I should pick up an M1 Pro MacBook, but it feels kind of useless, so I dropped the thought.

The game I play most often is [Minecraft](https://bgm.tv/subject/12596) (Java Edition ID: _Aurora_Lemon_), and I occasionally play Bed Wars. I do not think I really play anything else. I am not even sure whether [Turing Complete](https://bgm.tv/subject/434205) counts. I once had a dream of switching directions and going into hardware or embedded systems, but obviously that is not happening, haha.

I go to sleep at 4 AM and wake up at 11:30 AM almost every day. Total night owl. I am used to working at night. My VSCode and Obsidian themes are always light mode, by the way. In VSCode, my favorite built-in themes are Light Modern and GitHub Light, though GitHub Dark is also pretty nice. I do not go out very often. Unless someone literally shows up downstairs at my place and messages me that they are already there, I will usually make up some excuse to avoid going out. When I get bored, or when some weird little idea appears, I go talk to ChatGPT and Gemini. Claude banned my account, so I cannot ask it anything anymore.
